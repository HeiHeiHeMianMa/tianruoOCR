    ...
    internal static class Program
    {
        ...
        private static void InitConfig()
        {
            ...
            if (!File.Exists(path))
            {
                ...
                IniHelper.SetValue("快捷键", "文字识别", "F6");
                IniHelper.SetValue("快捷键", "翻译文本", "F9");
                IniHelper.SetValue("快捷键", "记录界面", "请按下快捷键");
                IniHelper.SetValue("快捷键", "识别界面", "请按下快捷键");
                IniHelper.SetValue("密钥_百度", "secret_id", "请输入secret_id");
                IniHelper.SetValue("密钥_百度", "secret_key", "请输入secret_key");
                IniHelper.SetValue("密钥_百度", "翻译appid", "请输入翻译appid");
                IniHelper.SetValue("密钥_百度", "翻译key", "请输入翻译key");
