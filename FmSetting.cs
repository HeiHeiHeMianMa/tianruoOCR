...
namespace TrOCR
{
	...
	public sealed partial class FmSetting
    {
		...
		{
			text_baiduaccount.Text = "GWbDZmgeK1SnajG6whN6dTac";
			text_baidupassword.Text = "GyURUAyk7mQ2dHnhnaPGoDdUty6NtrTv";
		}
